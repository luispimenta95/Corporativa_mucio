    ...
    <div class="container">
        ...
        <form method="POST" action="atualizarSenha.php">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Senha Provisória</label>
                    <input type="password" name="senhaP" class="form-control" id="inputPassword4" placeholder="Senha provisória" required>
                </div>
                <div class="form-group col-md-6">
